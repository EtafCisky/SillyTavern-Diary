...
function resetFloatWindowPosition() {
    ...
    // 获取悬浮窗元素尺寸
    const elementWidth = floatWindow.element.outerWidth();
    const elementHeight = floatWindow.element.outerHeight();
    ...
    console.log(`🎯 悬浮窗已居中: (${centerX}, ${centerY})`);
    toastr.info('悬浮窗位置已重置到屏幕中央', '日记本');
}
